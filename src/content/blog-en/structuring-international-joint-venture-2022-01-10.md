...
Here's what I learned leading two distinct entities simultaneously — a European FinTech and a local operations company in West Africa — as part of a super-app launch programme. The market context of that deployment is detailed in the article on [launching a super app in West Africa](/en/blog/launching-super-app-west-africa).
...
**The regulatory problem.** Operating a wallet or mobile money service in the BCEAO zone requires a locally incorporated entity, registered in the country, backed by a bank licensed with the [Central Bank of West African States](https://www.bceao.int). A European entity cannot be that counterparty. It can supply the technology. It cannot operate the financial flows.
...
> **Structuring an international operation and unsure about the governance model?** This type of decision is better made with experienced input before signing anything. [Let's take 30 minutes](https://izybiz.fr/contact).
...
**The solution: teams with latitude, not execution relays.** Both entities must have teams capable of making decisions within their scope without systematic escalation. The CEO sets the framework, validates structural decisions, and remains accessible to unblock situations. They shouldn't be in the loop for every operational decision. That's the core principle of an [interim management assignment](https://izybiz.fr/management-de-transition): give clear direction and create conditions for autonomy as quickly as possible.
...
The simplest rule: all costs that directly benefit the local company are borne by it. All costs that benefit the group (platform, security, R&D) are borne by the FinTech and included in the royalty. Grey areas are arbitrated by the CEO on a proportionality basis. Implementing [performance management by entity](https://izybiz.fr/pilotage-performance) — with dedicated dashboards — clarifies these trade-offs and protects both parties.
...
Legal structure is not a topic for lawyers alone. It's a management topic. To go further on this type of deployment in West Africa, the article on [launching a super app in West Africa](/en/blog/launching-super-app-west-africa) illustrates the operational field challenges.

**Structuring an international operation or joint venture and looking for an operational perspective on governance? [Get in touch](https://izybiz.fr/contact).**

---

*Account based on leading two entities simultaneously as part of a fintech platform deployment programme in West Africa. Regulatory framework: [OHADA](https://www.ohada.com) and [BCEAO](https://www.bceao.int).*
