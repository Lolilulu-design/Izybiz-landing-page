...
These obstacles aren't solved with a better app. They're solved with training, [field support and operational transition management](/management-de-transition), and business models adapted to the reality of informal commerce.
...
> **Operating or launching a digital payment service in an emerging market?** The field approach makes the difference. [Let's discuss your context](https://izybiz.fr/contact).
...
| What technology solves | What technology doesn't solve |
|---|---|
| Transaction cost | Trust in the system |
| Geographic accessibility | Product comprehension |
| Transfer speed | Savings behaviours |
| Technical interoperability | Community relationships |
| Regulatory compliance | Cultural barriers to use |
...
**Working on a fintech or digital payments project in an emerging market? [Get in touch](https://izybiz.fr/contact).**

---

*Field observations from operating a wallet and mobile payment platform as part of a super-app programme in West Africa. Sources: [GSMA State of the Industry Report on Mobile Money](https://www.gsma.com), [BCEAO](https://www.bceao.int), [World Bank Global Findex Database](https://www.worldbank.org/en/programs/globalfindex).*
